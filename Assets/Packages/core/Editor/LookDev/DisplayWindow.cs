...
namespace UnityEditor.Rendering.LookDev
{
    ...
    partial class DisplayWindow : EditorWindow, IViewDisplayer
    {
        ...
        {
            internal const string k_IconFolder = @"Packages/core/Editor/LookDev/Icons/";
            internal const string k_uss = @"Packages/core/Editor/LookDev/DisplayWindow.uss";
            internal const string k_uss_personal_overload = @"Packages/core/Editor/LookDev/DisplayWindow-PersonalSkin.uss";

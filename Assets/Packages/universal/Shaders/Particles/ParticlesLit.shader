...
Shader "Universal Render Pipeline/Particles/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Packages/universal/Shaders/Particles/ParticlesLitInput.hlsl"
            #include "Assets/Packages/universal/Shaders/Particles/ParticlesLitForwardPass.hlsl"
            ENDHLSL
        }
        Pass
        {

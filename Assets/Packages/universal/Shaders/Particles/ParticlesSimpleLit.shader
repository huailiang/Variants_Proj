...
Shader "Universal Render Pipeline/Particles/Simple Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Packages/universal/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Assets/Packages/universal/Shaders/Particles/ParticlesSimpleLitForwardPass.hlsl"
            ENDHLSL
        }
        Pass
        {

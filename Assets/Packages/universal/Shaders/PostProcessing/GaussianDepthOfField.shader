Shader "Hidden/Universal Render Pipeline/GaussianDepthOfField"
{
    ...
    HLSLINCLUDE
        ...
        #include "Assets/Packages/core/ShaderLibrary/Color.hlsl"
        #include "Assets/Packages/core/ShaderLibrary/Filtering.hlsl"
        #include "Assets/Packages/universal/ShaderLibrary/Core.hlsl"
        #include "Assets/Packages/universal/Shaders/PostProcessing/Common.hlsl"

Shader "Hidden/Universal Render Pipeline/Terrain/Lit (Base Pass)"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Packages/universal/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Assets/Packages/universal/Shaders/Terrain/TerrainLitPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Packages/universal/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Assets/Packages/universal/Shaders/Terrain/TerrainLitMetaPass.hlsl"

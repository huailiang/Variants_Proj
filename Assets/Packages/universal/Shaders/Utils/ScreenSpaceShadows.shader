Shader "Hidden/Universal Render Pipeline/ScreenSpaceShadows"
{
    SubShader
    {
        ...
        #include "Assets/Packages/core/ShaderLibrary/Common.hlsl"
        #include "Assets/Packages/core/ShaderLibrary/EntityLighting.hlsl"
        #include "Assets/Packages/core/ShaderLibrary/ImageBasedLighting.hlsl"
        #include "Assets/Packages/universal/ShaderLibrary/Core.hlsl"
        #include "Assets/Packages/universal/ShaderLibrary/Shadows.hlsl"
        #include "Assets/Packages/universal/ShaderLibrary/DeclareDepthTexture.hlsl"
